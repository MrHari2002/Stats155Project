...
basketball_model_1 <- glm(isWin ~ team_pts + team_ast + team_blk + team_reb + team_stl, data = team_stats)
...
team_reb -> The odds of a team winning increases by 1.1311 percent for every rebound that the team has during the game.

team_stl -> The odds of a team winning increases by 2.0051 percent for every steal that the team has during the game.

team_blk -> The odds of a team winning increases by 1.8279 percent for every block that the team has during the game.
...
pts -> The odds of a team winning increases by 1.804 percents for every point that a player scores in the game.

team_ast -> The odds of a team winning increases by 0.6364 percents for every assist that a player achieves in the game.

team_reb -> The odds of a team winning increases by 1.3184 percents for every rebound that a player has during the game.

team_stl -> The odds of a team winning increases by 0.1978 percents for every steal that a player has during the game.

team_blk -> The odds of a team winning increases by 0.6126 percents for every block that a player has during the game.
