...
team_pts -> The odds of a team winning increases by 1.6809 percent for every point that the team scores in the game.

team_ast -> The odds of a team winning increases by 0.6049 percent for every assist that the team achieves in the game.

team_reb -> The odds of a team winning increases by 1.0921 percent for every rebound that the team has during the game.

team_stl -> The odds of a team winning increases by 1.882 percent for every steal that the team has during the game.

team_blk -> The odds of a team winning increases by 1.8994 percent for every block that the team has during the game.
...
pts -> The odds of a team winning increases by 0.001804 for every point that a player scores in the game.

team_ast -> The odds of a team winning increases by 0.006364 for every assist that a player achieves in the game.

team_reb -> The odds of a team winning increases by 0.013184 for every rebound that a player has during the game.

team_stl -> The odds of a team winning increases by 0.001978 for every steal that a player has during the game.

team_blk -> The odds of a team winning increases by 0.006126 for every block that a player has during the game.
...
HomeTeamData <- gamedata %>% 
  select(nameTeam, idGame, locationGame, isWin, slugMatchup, team_pts) %>%
  arrange(idGame) %>%
  unique()

HomeTeamData %>% filter(locationGame == "H",isWin==TRUE) %>% count()
HomeTeamData %>% filter(locationGame == "H") %>% summarise(n())
