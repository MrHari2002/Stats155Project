...
team_pts -> The odds of a team winning increases by 0.016809 for every point that the team scores in the game.

team_ast -> The odds of a team winning increases by 0.006049 for every assist that the team achieves in the game.

team_reb -> The odds of a team winning increases by 0.010921 for every rebound that the team has during the game.

team_stl -> The odds of a team winning increases by 0.01882 for every steal that the team has during the game.

team_blk -> The odds of a team winning increases by 0.018994 for every block that the team has during the game.
...
locationGameH -> The odds of a team winning a game is 0.099 higher for games that are played at home than when a game is away. This means home teams are 9.9% more likely to win than away teams, so according to this model home-court advantage is significant.
